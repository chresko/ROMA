...
@property (strong,nonatomic) RBCarouselViewCell *previousCell;
@property (strong,nonatomic) RBCarouselViewCell *nextCell;
...
@interface RBCarouselViewCell : UICollectionViewCell
@property (nonatomic, strong) UILabel* title;
@end

@implementation RBCarouselViewCell
...
- (void)viewDidLoad
{
    ...
    [self.carousel registerClass:[RBCarouselViewCell class] forCellWithReuseIdentifier:@"ReuseCell"];
...
- (IBAction)customPan:(UIPanGestureRecognizer *)sender {
    ...
    if (sender.state == UIGestureRecognizerStateEnded) {
        ...
        self.previousCell = (RBCarouselViewCell*)[self.carousel cellForItemAtIndexPath:[NSIndexPath indexPathForItem:self.centerItem inSection:0]];
...
- (void)scrollToCenterItem {
    CGPoint nextOffset;
    RBCarouselViewCell *cell = (RBCarouselViewCell*)[self.carousel cellForItemAtIndexPath:[NSIndexPath indexPathForItem:self.centerItem inSection:0]];
    self.nextCell = cell;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    RBCarouselViewCell *cell = (RBCarouselViewCell*)[self.carousel dequeueReusableCellWithReuseIdentifier:@"ReuseCell" forIndexPath:indexPath];
    
    if (!cell) {
        cell = [[RBCarouselViewCell alloc] init];
    ...
    cell.title.frame = CGRectMake((cell.bounds.size.width - 120.0)/2.0,
                                  cell.bounds.origin.y + cell.bounds.size.height - 44.0, 120.0, 44.0);
    ...
    if (indexPath.row == self.centerItem) {
        ...
        cell.title.layer.zPosition = 1000;
    ...
    switch (number) {
        ...
        case 2:
            ...
            cell.title.text = @"Three";
            break;
            
        case 3:
            [cell setBackgroundColor:[UIColor redColor]];
            cell.title.text = @"Four";
            break;
            
        case 4:
            [cell setBackgroundColor:[UIColor yellowColor]];
            cell.title.text = @"Five";
            break;
